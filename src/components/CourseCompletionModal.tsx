...
export function CourseCompletionModal({
  ...
  return (
    <div className="fixed inset-0 z-[9998] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-[#003d7a] rounded-3xl shadow-2xl max-w-2xl w-full mx-auto my-8 overflow-hidden border border-white/20">
        {/* Animated Background */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-br from-[#0077e6]/20 to-[#0091ff]/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
          ...
          {/* Celebration Section */}
              <div className="text-center space-y-4 mb-6">
                ...
                <div className="grid grid-cols-3 gap-2 mt-4">
                  ...
                  <div className="bg-gradient-to-br from-[#005eb8]/20 to-[#0077e6]/20 backdrop-blur-sm border border-blue-400/30 rounded-xl p-3">
                    <Clock className="w-5 h-5 text-blue-400 mx-auto mb-2" />
                    <p className="text-blue-200 text-xs">{t('completion.completedOn')}</p>
                ...
                <div className="bg-gradient-to-r from-[#005eb8]/10 to-[#0077e6]/10 backdrop-blur-sm border border-blue-400/20 rounded-2xl p-4 mt-4">
