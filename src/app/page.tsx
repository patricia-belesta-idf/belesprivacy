    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 text-gray-900 overflow-hidden">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-blue-200/40 to-blue-300/40 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-br from-[#005eb8]/20 to-blue-200/40 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-gradient-to-br from-blue-300/40 to-blue-400/40 rounded-full blur-3xl animate-pulse delay-2000"></div>
        </div>
        ...
        <div className="relative z-10 text-center max-w-7xl mx-auto">
          ...
          <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-full shadow-sm mb-8">
            <Sparkles className="w-4 h-4 text-[#005eb8] mr-2" />
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#005eb8] to-[#0077e6] font-semibold">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-light mb-8 leading-tight tracking-wide">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#005eb8] to-[#0077e6]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <Card className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-sm hover:shadow-lg transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 w-full max-w-md">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-100/50 to-blue-200/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <CardHeader className="relative z-10 text-center pb-4">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 border border-blue-200/50 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Star className="w-8 h-8 text-[#005eb8]" />
                </div>
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-white/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <Link href="/signup">
              <Button size="lg" className="group relative overflow-hidden bg-gradient-to-r from-[#005eb8] to-[#0077e6] hover:from-[#0077e6] hover:to-[#0091ff] text-white text-lg px-10 py-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <Card className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-sm hover:shadow-lg transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 w-full max-w-md">
              ...
              <CardHeader className="relative z-10 text-center pb-4">
                <div className="mx-auto w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 border border-blue-200/50 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-3xl font-light text-[#005eb8] tracking-wider">3</span>
                </div>
      ...
      {/* CTA Section */}
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto text-center">
          {/* Subtle Background Elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-200/30 to-blue-300/30 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute top-1/2 right-1/4 w-80 h-80 bg-gradient-to-br from-[#005eb8]/20 to-blue-200/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/50 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/privacy">
              <Button className="bg-gradient-to-r from-[#005eb8] to-[#0077e6] hover:from-[#0077e6] hover:to-[#0091ff] text-white shadow-md hover:shadow-lg transition-all duration-200 px-8 py-3">
            ...
            <Link href="/legal">
              <Button className="bg-gradient-to-r from-[#0077e6] to-[#0091ff] hover:from-[#0091ff] hover:to-[#00a8ff] text-white shadow-md hover:shadow-lg transition-all duration-200 px-8 py-3">
